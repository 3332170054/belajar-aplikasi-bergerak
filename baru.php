...
$usernamebot="@telkom1233_bot"; //nama bot yang diperoleh dari BotFather
     ...
     // print_r($pesan);
      ...
      $pecah = explode(' ', $pesan, 2);
        ...
        case '/idteknisi@namabot':
        		...
        		$tampil="SELECT * FROM teknisi WHERE id_teknisi = '$idteknisi'"; 
                ...
                $text = "tiket anda : $idteknisi / $alamat_cus/ $no_pelanggan/ $nama_cus /$service_type" ;
        		//$text = "tiket anda \nid_teknisi: $json[0],  \nalamat_cus: $json ['alamat_cus'],";
                //$text .= "\nno_pelanggan: $json ['no_pelanggan'], \nnama_cus: $json ['nama_cus'],";
        ...
        case '/done@namabot':
            	include "koneksi.php";
        		if (isset($pecah[1])) {
					$no_tiket = $pecah[1];} //mendapatkan id teknisi dari kata kedua
					
        		$tampil="DELETE * FROM teknisi WHERE no_pelanggan = '$no_tiket'"; 
        		
        		$qryTampil=mysql_query($tampil); 
        		$text= "tiket telah terselesaikan";
        break;
